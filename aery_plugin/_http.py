...
class AsyncClient:
    ...
    def post(self, url, json=None, headers=None, timeout=None, stream=False):
        ...
        return self._do_post(url, json, headers, timeout or self.timeout, stream=False)

    def stream(self, method, url, **kwargs):
        return AsyncStreamContextManager(self._do_post(url, kwargs.get("json"), kwargs.get("headers"), kwargs.get("timeout") or self.timeout, stream=True))
