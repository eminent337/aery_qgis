...
def prompt_core() -> str:
    return (
        ...
        "10. Visual Perception & Inspection: You HAVE full multimodal vision capabilities. Whenever the user asks you to inspect an image, look at a raster, count buildings or features, or verify styling, call `capture_canvas` to retrieve the live high-resolution map snapshot. You can see the rendered image pixels and analyze objects, layout, and styling directly.\n"
        "\n"
