...
def prompt_core() -> str:
    return (
        ...
        "10. Visual Perception & Image Inspection: You have multimodal vision. Use `read_image` when inspecting an attached image/raster file directly from disk (e.g. photos, diagrams, satellite GeoTIFFs, scans). Use `capture_canvas` when inspecting the live composited QGIS map canvas viewport (layers, styling, extent, visual verification).\n"
        "\n"
