...
def get_auth_entry(provider_id: str) -> Optional[dict]:
    """Return the auth entry for a provider, or None if not configured."""
    auth = _load_auth()
    entry = auth.get(provider_id)
    if entry:
        return entry
    # Back-compat: some entries may use nested provider key
...
def _oauth_models(pid: str) -> list[tuple]:
    if pid == "kilo":
        ...
        if os.path.exists(cache_path):
            try:
                ...
                pass
        # Fallback to verified working free models
        return [
    ...
    models = {
        "kilo": [
            ...
            ("baidu/ernie-4.5-vl-424b-a47b-thinking", "Baidu: ERNIE 4.5 VL 424B A47B Thinking"),
            ("baidu/ernie-4.5-vl-8b-a3b", "Baidu: ERNIE 4.5 VL 8B A3B"),
            ("baidu/ernie-5", "Baidu ERNIE 5"),
            ("baidu/ernie-5-thinking", "Baidu ERNIE 5 Thinking"),
            ("baidu/ernie-5-ultra", "ERNIE 5 Ultra"),
            ("baidu/ernie-speed-128k:free", "Baidu Qianfan: ERNIE Speed 128k (free)"),
            ("bigcode/starcoder-2-15b-instruct", "BigCode: StarCoder2 15B Instruct"),
            ("bigscience/bloom", "BLOOM 176B"),
            ("black-forest-labs/flux-1-schnell", "Black Forest Labs: FLUX.1 Schnell"),
            ("bytedance/doubao-1.5-pro", "ByteDance: Doubao 1.5 Pro"),
            ("bytedance/doubao-1.5-pro-thinking", "ByteDance: Doubao 1.5 Pro Thinking"),
            ("bytedance/doubao-1.5-pro-vl", "ByteDance: Doubao 1.5 Pro VL"),
            ("carperai/fross-7b", "CarperAI: Fross 7B"),
            ("cognitivecomputations/dolphin-2.9-llama-3-70b", "Dolphin 2.9 Llama 3 70B"),
            ("cognitivecomputations/dolphin-2.9-llama-3-8b", "Dolphin 2.9 Llama 3 8B"),
            ("cognitivecomputations/dolphin-2.9.1-yi-34b", "Dolphin 2.9.1 Yi 34B"),
            ("cognitivecomputations/dolphin-2.9.2-qwen-2.5-72b", "Dolphin 2.9.2 Qwen 2.5 72B"),
            ("cognitivecomputations/dolphin-2.9.3-mistral-nemo-12b", "Dolphin 2.9.3 Mistral Nemo 12B"),
            ("cohere/command-r-plus-08-2024", "Command R+ (08-2024)"),
            ("cohere/command-r-plus-12-2024", "Command R+ (12-2024)"),
            ("cohere/command-r-plus-vl", "Cohere: Command R+ VL"),
            ("cohere/command-r-plus-vl-2", "Cohere: Command R+ VL 2.0"),
            ("cohere/north-mini-code", "Cohere: North Mini Code"),
            ("cohere/north-mini-code:free", "Cohere: North Mini Code (free)"),
            ("cyberagent/calm3-22b-chat", "CyberAgent: CALM3 22B Chat"),
            ("databricks/dbrx-instruct", "DBRX Instruct"),
            ("decision-force/cyber-reasoner-72b", "DecisionForce: Cyber Reasoner 72B"),
            ("decision-force/cyber-reasoner-8b", "DecisionForce: Cyber Reasoner 8B"),
            ("deepinfra/deepinfra-gateway", "DeepInfra Gateway"),
            ...
            ("dify/dify-gateway", "Dify Gateway"),
            ("eleutherai/gpt-j-6b", "GPT-J 6B"),
            ("eleutherai/gpt-neox-20b", "GPT-NeoX 20B"),
            ("ensemble/ensemble-gateway", "Ensemble Gateway"),
            ("facebook/galactica-120b", "Galactica 120B"),
            ("fireworks/fireworks-gateway", "Fireworks Gateway"),
            ("friendly-multimodal/vision-helper-7b", "FriendlyMultimodal: Vision Helper 7B"),
            ...
            ("google/gemma-3-9b-it", "Google: Gemma 3 9B IT"),
            ("google/gemma-3-9b-pt", "Google: Gemma 3 9B PT"),
            ("google/gemini-1.5-flash", "Gemini 1.5 Flash"),
            ("google/gemini-1.5-flash-8k", "Gemini 1.5 Flash 8k"),
            ...
            ("google/shieldgemma-2b", "Google: ShieldGemma 2B"),
            ("gryphe/mythalion-13b", "Mythalion 13B"),
            ("gryphe/mythomax-l2-13b", "Mythomax L2 13B"),
            ("hyperbolic/hyperbolic-gateway", "Hyperbolic Gateway"),
            ("jeonsang/reasoning-1b-preview", "Jeonsang: Reasoning-1B Preview"),
            ("kai-okada/japanese-gemma-2b-it-v2", "KaiOkada: Japanese Gemma 2B IT V2"),
            ("koboldai/koboldcpp-gateway", "KoboldCPP Gateway"),
            ("lambda/lambda-gateway", "Lambda Gateway"),
            ("light-reasoning/light-reasoner-3b", "LightReasoning: Light Reasoner 3B"),
            ("liquid/lfm-40b", "Liquid: LFM 40B"),
            ("lmstudio/lmstudio-gateway", "LM Studio Gateway"),
            ("lmsys/lmsys-gateway", "LMSYS Gateway"),
            ...
            ("meta-llama/llama-3.3-70b-instruct:thinking", "Meta: Llama 3.3 70B Instruct (thinking)"),
            ("meta-llama/llama-4-1b-instruct", "Meta: Llama 4 1B Instruct"),
            ("meta-llama/llama-4-24b-instruct", "Meta: Llama 4 24B Instruct"),
            ("meta-llama/llama-4-24b-instruct:thinking", "Meta: Llama 4 24B Instruct (thinking)"),
            ("meta-llama/llama-4-405b-instruct", "Meta: Llama 4 405B Instruct"),
            ("meta-llama/llama-4-405b-instruct:thinking", "Meta: Llama 4 405B Instruct (thinking)"),
            ("meta-llama/llama-4-8b-instruct", "Meta: Llama 4 8B Instruct"),
            ("meta-llama/llama-4-8b-instruct:thinking", "Meta: Llama 4 8B Instruct (thinking)"),
            ("meta-llama/llama-guard-3-8b", "Meta: Llama Guard 3 (8B)"),
            ("meta-llama/llama-guard-3-8b-int8", "Meta: Llama Guard 3 (8B INT8)"),
            ("meta-llama/llama-guard-4-8b", "Meta: Llama Guard 4 (8B)"),
            ("meta-llama/llama-safety-1b", "Meta: Llama Safety 1B"),
            ("minimax/abab6.5-chat", "MiniMax: Abab6.5 Chat"),
            ("minimax/abab7-chat", "MiniMax: Abab7 Chat"),
            ("minimax/abab7-thinking", "MiniMax: Abab7 Thinking"),
            ("mistralai/codestral-2405", "Codestral 2405"),
            ("mistralai/codestral-latest", "Codestral (latest)"),
            ("mistralai/codestral-mamba", "Codestral Mamba"),
            ("mistralai/large-2407", "Mistral Large (2407)"),
            ("mistralai/large-2411", "Mistral Large (2411)"),
            ("mistralai/large-2412", "Mistral Large (2412)"),
            ("mistralai/large-2502", "Mistral Large (2502)"),
            ...
            ("mistralai/pixtral-large-latest", "Pixtral Large (latest)"),
            ("moonshotai/kimi-k2", "Kimi K2"),
            ("moonshotai/kimi-k2-thinking", "Kimi K2 Thinking"),
            ("moonshotai/kimi-k2.5", "Kimi K2.5"),
            ("moonshotai/kimi-k2.5-thinking", "Kimi K2.5 Thinking"),
            ("moonshotai/kimi-k3", "Kimi K3"),
            ("moonshotai/kimi-k3-thinking", "Kimi K3 Thinking"),
            ("moonshotai/kimi-k3-vl", "Kimi K3 VL"),
            ("mradermacher/mythalion-13b-i1-guf", "MRadermacher: Mythalion 13B I1 GUF"),
            ("neat-code/neat-coder-12b", "NeatCode: Neat Coder 12B"),
            ("neat-code/neat-coder-3b", "NeatCode: Neat Coder 3B"),
            ("neat-code/neat-coder-72b", "NeatCode: Neat Coder 72B"),
            ("neat-code/neat-coder-7b", "NeatCode: Neat Coder 7b"),
            ("neat-code/neat-reasoner-7b", "NeatCode: Neat Reasoner 7b"),
            ("neural-chat/neural-chat-7b-v3-3", "Neural Chat 7B v3.3"),
            ("novita/novita-gateway", "Novita Gateway"),
            ("nomic-ai/nomic-embed-text-v1.5", "Nomic: Embed Text v1.5"),
            ("nvidia/nemotron-3-nano-omni-30b-a3b-reasoning:free", "NVIDIA: Nemotron 3 Nano Omni (free)"),
            ("nvidia/nemotron-3-super-120b-a12b", "Nemotron 3 Super"),
            ("nvidia/nemotron-3-super-120b-a12b:free", "NVIDIA: Nemotron 3 Super (free)"),
            ("ollama/ollama-gateway", "Ollama Gateway"),
            ("open-interpreter/open-interpreter-gateway", "Open Interpreter Gateway"),
            ...
            ("openai/o3-mini-high", "OpenAI: o3-mini (High reasoning)"),
            ("openai/o3-mini-low", "OpenAI: o3-mini (Low reasoning)"),
            ("openai/o4-mini", "o4 Mini (latest)"),
            ("openrouter/openrouter-gateway", "OpenRouter Gateway"),
            ("openrouter/free", "OpenRouter Free Models"),
            ("palm/palm-gateway", "PaLM Gateway"),
            ...
            ("qwen/qwen-plus-latest", "Qwen Plus (latest)"),
            ("qwen/qwen-turbo", "Qwen Turbo"),
            ("qwen/qwen-turbo-latest", "Qwen Turbo (latest)"),
            ("qwen/qwq-32b-preview", "QwQ 32B Preview"),
            ("qwen/qwq-72b", "Qwen: Qwq 72B"),
            ("qwen/qwq-72b-preview", "Qwen: Qwq 72B Preview"),
            ("qwen/qwq-72b:thinking", "Qwen: Qwq 72B (thinking)"),
            ("replicate/replicate-gateway", "Replicate Gateway"),
            ("runpod/runpod-gateway", "RunPod Gateway"),
            ("sambanova/sambanova-gateway", "SambaNova Gateway"),
            ("sf-computational/sf-reasoner-7b", "SFComputational: SF Reasoner 7B"),
            ("together/together-gateway", "Together Gateway"),
...
def set_active_provider(provider_id: str, model: str = "") -> None:
    ...
    if model:
        # Guard: Kilo now requires credits for non-free models. Never persist a
        # paid model for kilo, or the engine will immediately 402 on every call.
        if provider_id == "kilo" and ":free" not in model and model != "openrouter/free":
